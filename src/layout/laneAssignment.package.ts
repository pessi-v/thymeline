/**
 * Minimal lane assignment for package distribution
 * Uses only succession-based layout algorithm
 */

import type { TimelinePeriod, TimelineEvent, TimelineConnector, LaneAssignment } from '../core/types';
import { PERIOD_LAYOUT_ALGORITHMS, DEFAULT_PERIOD_LAYOUT, assignEventLanes } from './algorithms/package';
